...
from infrastructure.supabase_repository import SupabaseConversationRepository, SupabaseJudgmentRepository
...
async def lifespan(app: FastAPI):
    ...
    judgment_repository = SupabaseJudgmentRepository(settings)
