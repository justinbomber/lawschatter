...
class GrokExtractionService(ILLMExtractionService):
    """
    Grok Extraction Service using instructor library.
    
    Note: Using instructor library to handle UTF-8 encoding issues with Grok API.
    Instructor provides better handling for structured outputs with non-ASCII characters.
    
    Reference: https://python.useinstructor.com/integrations/xai/
    """
